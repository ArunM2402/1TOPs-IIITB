...
1) Core developed with minimal support.
   ...
   * Testbench Version 2 - 48/48 tests passed. (Mimicked ISA Compliance tests from literature).
   * Testbench Version 3 - 20 Direct Tests. 81/81 individual tests passed.
   * RISC-DV tests done.
   * RISC-ARCH Certifications tests done.  
2) Cadence Scripts
   * Working for 45nm.
